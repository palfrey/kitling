"""
Django settings for kitling project.
...
SECRET_KEY = '@%9#-nx1)=4i3z5ze_c_s$fbwu-_-4pj(53llb+h=tm^jyfrwn'
...
WSGI_APPLICATION = 'kitling.wsgi.application'
